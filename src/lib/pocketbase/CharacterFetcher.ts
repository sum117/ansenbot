  ...
  public static async createCharacter(char: CreateData<Character>): Promise<Character | void> {
    ...
    const [baseSkills, baseStatus, body, inventory, player] = await Promise.all([
      ...
      PocketBase.createEntity<Status>({
        entityData: {
          health: 100 + skills.vigor * STATUS_GAIN_PER_LEVEL.health,
          spirit: 100,
          mana: 100 + skills.intelligence * STATUS_GAIN_PER_LEVEL.mana,
          stamina: 100 + skills.fortitude * STATUS_GAIN_PER_LEVEL.stamina,
          despair: 100 + skills.darkness * STATUS_GAIN_PER_LEVEL.despair,
          hunger: 100 + skills.fortitude * STATUS_GAIN_PER_LEVEL.hunger,
          void: 100 + skills.darkness * STATUS_GAIN_PER_LEVEL.void,
          sleep: 100 + skills.fortitude * STATUS_GAIN_PER_LEVEL.sleep,
          effects: [],
          immune: [],
          ...baseMaterials,
        },
